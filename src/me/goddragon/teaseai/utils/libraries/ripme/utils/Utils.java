...
public class Utils {
    ...
    /**
     * Gets and returns a list of all the album rippers present in the " me.goddragon.teaseai.utils.libraries.imagedownloading.com.rarchives.ripme.ripper.rippers" package.
     *
     * @return List<String> of all album rippers present.
     */
    public static List<String> getListOfAlbumRippers() throws Exception {
        List<String> list = new ArrayList<>();
        for (Constructor<?> ripper : AbstractRipper.getRipperConstructors(" me.goddragon.teaseai.utils.libraries.imagedownloading.com.rarchives.ripme.ripper.rippers")) {
    ...
    public static List<String> getListOfVideoRippers() throws Exception {
        List<String> list = new ArrayList<>();
        for (Constructor<?> ripper : AbstractRipper.getRipperConstructors(" me.goddragon.teaseai.utils.libraries.imagedownloading.com.rarchives.ripme.ripper.rippers.video")) {
            list.add(ripper.getName());
        }
        return list;
    }
